...
| `imagePullSecret.registry` | Registry to pull Enterprise images from | "docker.io" |
| `imagePullSecret.user` | Username for the image registry | "" |
| `imagePullSecret.token` | Token/password for the image registry | "" |
...
| `services.icc.secrets.control_plane_keys` | Random value to secure the control plane | "" | Yes |
| `services.icc.secrets.user_manager_session` | Random value to secure user manager sessions | "" | Yes |
